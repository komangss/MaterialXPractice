...
public class FragmentBottomSheetDialogFull extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // set data to view
        ((TextView) view.findViewById(R.id.name)).setText("nama");
        ((TextView) view.findViewById(R.id.name_toolbar)).setText("nama");

//        baru
        int height = Resources.getSystem().getDisplayMetrics().heightPixels;

        ((View) view.findViewById(R.id.lyt_spacer)).setMinimumHeight(height / 2);
